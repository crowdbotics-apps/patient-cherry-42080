"""
Django settings for patient_cherry_42080 project.
...
ROOT_URLCONF = 'patient_cherry_42080.urls'
...
WSGI_APPLICATION = 'patient_cherry_42080.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_cherry_42080 API",
    "DESCRIPTION": "API documentation for patient_cherry_42080 App",
    "VERSION": "v1",
}
